...
set :application, "Economic-Platforms-Staging" # unique name of application
set :user, "ecplatform-staging" # name of user on server
...
set :github_repo_name, "EconomicPlatforms" # name of git hub repo
set :git_branch_name, "new_translations" # name of branch to deploy
