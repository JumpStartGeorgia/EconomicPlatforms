EconomicPlatforms::Application.configure do
  ...
  #config.assets.precompile += ['tiny_mce/tiny_mce.js']

  # Disable delivery errors, bad email addresses will be ignored
  config.action_mailer.raise_delivery_errors = false
	config.action_mailer.default_url_options = { :host => 'dev-js.jumpstart.ge' }
