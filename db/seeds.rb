...
pp.political_party_translations.create(:name=>"ქრისტიანულ-დემოკრატიული მოძრაობა", :locale=>"ka")
...
pp.political_party_translations.create(:name=>"ახალი მემარჯვენეები პარტია", :locale=>"ka")
